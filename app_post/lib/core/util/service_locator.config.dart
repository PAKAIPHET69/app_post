...
import 'package:app_post/core/util/register_modules.dart' as _i47;
...
import 'package:app_post/features/post/domain/usecases/get_currentuser.dart'
    as _i35;
import 'package:app_post/features/post/domain/usecases/get_follow.dart' as _i36;
...
import 'package:app_post/features/post/domain/usecases/get_view_comment.dart'
    as _i40;
import 'package:app_post/features/post/domain/usecases/likes_post.dart' as _i41;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i36.GetFollowUsecase>(
        () => _i36.GetFollowUsecase(gh<_i18.PostRepository>()));
    gh.lazySingleton<_i37.GetPostCommentsUsecase>(
        () => _i37.GetPostCommentsUsecase(gh<_i18.PostRepository>()));
    gh.lazySingleton<_i38.GetPostsUsecase>(
        () => _i38.GetPostsUsecase(gh<_i18.PostRepository>()));
    gh.lazySingleton<_i39.GetTokenUsecase>(
        () => _i39.GetTokenUsecase(gh<_i27.SignInRepository>()));
    gh.lazySingleton<_i40.GetViewCommentsUsecase>(
        () => _i40.GetViewCommentsUsecase(gh<_i18.PostRepository>()));
    gh.lazySingleton<_i41.LikesPostUsecase>(
        () => _i41.LikesPostUsecase(gh<_i18.PostRepository>()));
    gh.factory<_i42.PostCubit>(() => _i42.PostCubit(
          gh<_i20.PostUsecase>(),
          gh<_i35.GetCurrentUser>(),
          gh<_i30.UploadImageUsecese>(),
          gh<_i38.GetPostsUsecase>(),
          gh<_i33.DeletePostUsecase>(),
          gh<_i29.UpdatePostUsecase>(),
          gh<_i31.CommentUsecase>(),
          gh<_i37.GetPostCommentsUsecase>(),
          gh<_i32.DeleteCommentUsecase>(),
          gh<_i40.GetViewCommentsUsecase>(),
          gh<_i41.LikesPostUsecase>(),
          gh<_i36.GetFollowUsecase>(),
        ));
    gh.factory<_i43.SearchCubit>(
        () => _i43.SearchCubit(gh<_i24.SearchUsecse>()));
    gh.lazySingleton<_i44.SigInGoogleUsecase>(
        () => _i44.SigInGoogleUsecase(gh<_i27.SignInRepository>()));
    gh.lazySingleton<_i45.SigInfacebookUsecase>(
        () => _i45.SigInfacebookUsecase(gh<_i27.SignInRepository>()));
    gh.factory<_i46.SignInCubit>(() => _i46.SignInCubit(
          gh<_i44.SigInGoogleUsecase>(),
          gh<_i45.SigInfacebookUsecase>(),
          gh<_i39.GetTokenUsecase>(),
        ));
    return this;
  }
}
